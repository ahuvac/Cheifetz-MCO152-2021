...
//        doReturn("").when(letterLabels.get(1)).getText();
//        doReturn("").when(letterLabels.get(2)).getText();
//        doReturn(true).when(dictionary).hasWord("CAT");
//        doReturn("E", "S", "T")
//                .when(letterBag).nextLetter();
//
//        // when
...
//
//        // then
//        verify(dictionary).hasWord("CAT");
//        verify(pointsLabel).setText("3");
//        Assert.assertEquals(3, controller.numPoints);
...
//        doReturn(false).when(dictionary).hasWord("QWS");
//
//        // when
//        controller.onSubmit(mock(ActionEvent.class));
//
//        // then
//        verify(dictionary).hasWord("QWS");
//        verifyNoInteractions(pointsLabel);
//        Assert.assertEquals(0, controller.numPoints);
